...
def transitionFunction(
    ...
    return transition_function(previous_pose, control, b)
...
def measurementFunction(
    ...
    return measurement_function(pose, map_line)


def associateMeasurements(
    pose: Sequence[float],
    covariance: Sequence[float] | numpy.ndarray,
    observations: Sequence[Sequence[float]] | numpy.ndarray,
    measurement_covariances: numpy.ndarray | Sequence[numpy.ndarray],
    ...
    return result.innovation, result.jacobian, result.covariance
